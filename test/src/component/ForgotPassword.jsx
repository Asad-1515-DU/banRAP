...
import { sendOTPForPasswordReset, verifyOTP, resetPassword, getUserByEmail } from '../utils/fakeDatabase.js';
...
function ForgotPassword() {
  ...
  const validateEmail = () => {
    ...
    if (!email) {
      ...
      newErrors.email = 'Email not found in our system';
    }
  ...
  const handleEmailSubmit = (e) => {
    ...
    if (validateEmail()) {
      ...
      // Simulate API call
      setTimeout(() => {
        const result = sendOTPForPasswordReset(email);
        if (result.success) {
          setSuccessMessage(result.message);
          console.log('OTP sent to email:', result.otp); // For demo purposes
          setTimeout(() => {
            setStep(2);
            setSuccessMessage('');
          }, 1500);
